...
export const OnboardingFlow: FC<OnboardingFlowProps> = ({ onComplete, onSkip }) => {
  ...
  return (
      ...
      <div className="w-full max-w-2xl rounded-3xl border border-zinc-200 bg-white p-6 shadow-[0_24px_80px_rgba(0,0,0,0.45)] backdrop-blur-sm sm:p-8">
        ...
        {step === 1 ? (
          <div className="fade-in slide-in-from-bottom-1 animate-in space-y-6 duration-300">
            <div className="space-y-3">
              <h1 className="text-3xl font-semibold tracking-tight text-zinc-900">Welcome to your AI Assistant</h1>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="h-14 w-full rounded-2xl border border-zinc-200 bg-background px-4 text-base text-zinc-900 outline-none transition-all placeholder:text-neutral-500 focus:border-neutral-500 focus:ring-2 focus:ring-neutral-700/60"
                placeholder="e.g. 15"
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                className="h-11 rounded-2xl bg-white px-6 text-sm font-medium text-black transition-all hover:bg-neutral-200 disabled:bg-zinc-100 disabled:text-zinc-400 ml-auto"
              >
                Next
              </Button>
            </div>
          ...
          <div className="fade-in slide-in-from-bottom-1 animate-in space-y-6 duration-300">
            <div className="space-y-3">
              <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">Enter your courses this semester</h2>
            ...
            <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_120px_auto] sm:items-end">
              <div className="space-y-2 sm:order-1">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-2xl border border-zinc-200 bg-background px-4 text-sm text-zinc-900 outline-none transition-all placeholder:text-neutral-500 focus:border-neutral-500 focus:ring-2 focus:ring-neutral-700/60"
              ...
              <Button
                ...
                className="h-12 rounded-2xl bg-white px-5 text-sm font-medium text-black transition-all hover:bg-neutral-200 disabled:bg-zinc-100 disabled:text-zinc-400 sm:order-3"
              >
                Add Course
              </Button>
            </div>
            ...
            <div className="space-y-3 rounded-2xl border border-white/8 bg-black/20 p-3">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-zinc-900">Added Courses</span>
                <span className="text-xs text-neutral-500">{draftCourses.length} course{draftCourses.length !== 1 ? "s" : ""}</span>
              </div>

              {draftCourses.length === 0 ? (
                <div className="rounded-xl border border-dashed border-zinc-200 px-4 py-6 text-center text-sm text-neutral-500">
                ...
                <div className="flex flex-col gap-1">
                  {draftCourses.map((course) => (
                    <div
                      key={course.id}
                      className="flex items-center justify-between gap-3 rounded-xl px-3 py-2 text-sm text-zinc-600 transition-colors duration-150 hover:bg-zinc-100 hover:text-zinc-900"
                    >
                      ...
                      <button
                        ...
                        className="flex size-7 shrink-0 items-center justify-center rounded-full text-neutral-500 transition-colors hover:bg-zinc-100 hover:text-zinc-900"
            ...
            <div className="flex items-center justify-between gap-3">
              <Button
                ...
                variant="ghost"
                onClick={() => setStep(1)}
                className="h-11 rounded-2xl px-4 text-neutral-400 hover:bg-zinc-100 hover:text-zinc-900"
              >
                Back
              </Button>
              <Button
                ...
                className="h-11 rounded-2xl bg-white px-6 text-sm font-medium text-black transition-all hover:bg-neutral-200 disabled:bg-zinc-100 disabled:text-zinc-400"
              >
